...
data "http" "route53_perms" {
  url = "https://raw.githubusercontent.com/openshift/managed-cluster-config/refs/heads/master/resources/sts/hypershift/openshift_hcp_shared_vpc_route_53_credentials_policy.json"
