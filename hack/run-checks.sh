...
Modes:
  basic                    Steps: verify, verify-gen, lint, unit-tests, license-check, docs-lint
...
case "$mode" in
  basic)
    append_step "Terraform validate (examples)" "make --no-print-directory verify"
    append_step "Generated docs check" "make --no-print-directory verify-gen"
    append_step "Lint (terraform fmt + tflint)" "make --no-print-directory lint"
    append_step "Module unit tests" "make --no-print-directory unit-tests"
